...
public interface NightVisionCameraPrx extends MonitoringCameraPrx
{
    default void changeIRMode()
        throws DeviceError
    {
        changeIRMode(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void changeIRMode(java.util.Map<String, String> context)
        throws DeviceError
    {
        try
        {
            _iceI_changeIRModeAsync(context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<Void> changeIRModeAsync()
    {
        return _iceI_changeIRModeAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> changeIRModeAsync(java.util.Map<String, String> context)
    {
        return _iceI_changeIRModeAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_changeIRModeAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "changeIRMode", null, sync, _iceE_changeIRMode);
        f.invoke(true, context, null, null, null);
        return f;
    }

    /** @hidden */
    static final Class<?>[] _iceE_changeIRMode =
    {
        DeviceError.class
    };
